...
seismic_scenario['ages'] = np.array([7000, 2500, 500]) # exhumation ages, older to younger (yr)
# seismic_scenario['ages'] = torch.tensor([6443.1968, 5138.0879, 4698.4023,  153.3770])
seismic_scenario['slips'] = np.array([300, 300, 300]) # slip corresponding to the events (cm)
